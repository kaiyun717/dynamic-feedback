...
launch_angle = 65;                    % Launch Angle (degree)
v0 = 35;                              % Initial velocity (m/s)
v0_x = 35 * cosd(launch_angle);       % Initial velocity in x-direction (m/s)
v0_y = 35 * sind(launch_angle);       % Initial velocity in y-direction (m/s)
